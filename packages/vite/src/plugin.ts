...
import { applyEnvOverrides, buildConfigScript } from '@runtime-config/core'
import type { RuntimeConfigInput, RuntimeConfigPluginOptions } from '@runtime-config/core'
...
function generateTypeFile(config: RuntimeConfigInput, configFilePath: string): void {
  ...
  const content = `// Auto-generated by @runtime-config/vite — do not edit manually.

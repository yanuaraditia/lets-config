...
import { applyEnvOverrides, buildConfigScript } from 'lets-config'
import type { RuntimeConfigInput, RuntimeConfigPluginOptions } from 'lets-config'
...
function generateTypeFile(config: RuntimeConfigInput, configFilePath: string): void {
  ...
  const content = `// Auto-generated by @lets-config/vite — do not edit manually.
